...
public final class ResultSet {
     ...
     * @return
     */
    public static Map<String, Object> success(Collection<? extends Object> data) {
     ...
     * @return
     */
    public static Map<String, Object> success(Object dataset) {
     ...
     */
    public static Map<String, Object> error(String errorMsg, Map additionalReturnValuesMap) {
