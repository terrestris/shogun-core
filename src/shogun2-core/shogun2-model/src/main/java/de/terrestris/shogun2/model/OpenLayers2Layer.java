...
/**
 * The model is based on the OpenLayers2-Layer-model:
 * http://dev.openlayers.org/releases/OpenLayers-2.13.1/doc/apidocs/files/OpenLayers/Layer-js.html
 * 
 * @author Nils Bühner
 * 
 */
@Entity
@Table
public class OpenLayers2Layer extends Layer {
